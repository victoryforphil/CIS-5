...
V1:
 - Moved Playloop to its own function
 - Moved Player Struct to be global to allow play state transfer
 - Now plays 3 rounds of the game
...
void playRound(std::vector<player> &plyrs);
...
void playRound(std::vector<player> &players){
