...
void display(float balance[], int year[], int dYear[], int nYears, float intRate, float yrDpPc, float salary)
{
...
void savings(float balance[], int year[], int dYear[], int nYears, float &intRate, float yrDpPc, float salary)
{
     float yrDep = yrDpPc * salary;
     intRate /= CNVDCML;
       //Loop for all years
